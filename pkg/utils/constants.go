...
const VersionCsiCephPlugin = "quay.io/cephcsi/cephcsi:v3.6.1"
...
const VersionCertManagerCtl = "quay.io/jetstack/cert-manager-ctl:v1.5.3"
const VersionCertManagerController = "quay.io/jetstack/cert-manager-controller:v1.5.3"
const VersionCertManagerCAInjector = "quay.io/jetstack/cert-manager-cainjector:v1.5.3"
const VersionCertManagerWebHook = "quay.io/jetstack/cert-manager-webhook:v1.5.3"
const VersionNginxIngressAdmissionWebhook = "k8s.gcr.io/ingress-nginx/kube-webhook-certgen:v1.0"
const VersionNginxIngressController = "k8s.gcr.io/ingress-nginx/controller:v1.0.0"
