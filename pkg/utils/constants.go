...
const VersionCalicoTypha = "quay.io/calico/typha:v3.23.1"
const VersionCalicoNode = "quay.io/calico/node:v3.23.1"
const VersionCalicoCni = "quay.io/calico/cni:v3.23.1"
const VersionCalicoKubeControllers = "quay.io/calico/kube-controllers:v3.23.1"
const VersionCeph = "quay.io/ceph/ceph:v17.2.0"
const VersionCsiCephPlugin = "quay.io/cephcsi/cephcsi:v3.6.2"
...
const VersionCsiSnapshotter = "k8s.gcr.io/sig-storage/csi-snapshotter:v5.0.1"
const VersionCsiSnapshotController = "k8s.gcr.io/sig-storage/snapshot-controller:v5.0.1"
const VersionCsiDriverRegistrar = "k8s.gcr.io/sig-storage/csi-node-driver-registrar:v2.4.0"
const VersionCsiResizer = "k8s.gcr.io/sig-storage/csi-resizer:v1.4.0"
