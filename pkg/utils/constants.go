...
const VersionCalicoTypha = "quay.io/calico/typha:v3.24.0"
const VersionCalicoNode = "quay.io/calico/node:v3.24.0"
const VersionCalicoCni = "quay.io/calico/cni:v3.24.0"
const VersionCalicoKubeControllers = "quay.io/calico/kube-controllers:v3.24.0"
const VersionCeph = "quay.io/ceph/ceph:v17.2.3"
const VersionCsiCephPlugin = "quay.io/cephcsi/cephcsi:v3.7.0"
...
const VersionCsiSnapshotController = "k8s.gcr.io/sig-storage/snapshot-controller:v6.0.1"
...
const VersionKubernetesDashboard = "docker.io/kubernetesui/dashboard:v2.6.0"
const VersionCertManagerCtl = "quay.io/jetstack/cert-manager-ctl:v1.8.1"
const VersionCertManagerController = "quay.io/jetstack/cert-manager-controller:v1.8.1"
const VersionCertManagerCAInjector = "quay.io/jetstack/cert-manager-cainjector:v1.8.1"
const VersionCertManagerWebHook = "quay.io/jetstack/cert-manager-webhook:v1.8.1"
const VersionNginxIngressAdmissionWebhook = "k8s.gcr.io/ingress-nginx/kube-webhook-certgen:v1.1.1"
const VersionNginxIngressController = "k8s.gcr.io/ingress-nginx/controller:v1.2.1"
