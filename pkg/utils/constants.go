...
const VersionContainerd = "1.7.0"
const VersionRunc = "1.1.4"
const VersionCrictl = "1.27.0"
const VersionHelm = "3.11.2"
...
const VersionCoreDNS = "docker.io/coredns/coredns:1.10.1"
...
const VersionCsiCephPlugin = "quay.io/cephcsi/cephcsi:v3.8.0"
const VersionCsiProvisioner = "k8s.gcr.io/sig-storage/csi-provisioner:v3.3.0"
const VersionCsiAttacher = "registry.k8s.io/sig-storage/csi-attacher:v4.0.0"
const VersionCsiSnapshotter = "registry.k8s.io/sig-storage/csi-snapshotter:v6.1.0"
const VersionCsiSnapshotController = "registry.k8s.io/sig-storage/snapshot-controller:v6.2.1"
const VersionCsiDriverRegistrar = "registry.k8s.io/sig-storage/csi-node-driver-registrar:v2.6.2"
const VersionCsiResizer = "registry.k8s.io/sig-storage/csi-resizer:v1.6.0"
