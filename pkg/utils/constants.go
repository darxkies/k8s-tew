...
const VersionEtcd = "quay.io/coreos/etcd:v3.5.7"
const VersionContainerd = "1.6.15"
const VersionRunc = "1.1.4"
const VersionCrictl = "1.26.0"
const VersionHelm = "3.11.0"
const VersionGobetween = "docker.io/yyyar/gobetween:0.8.0"
const VersionVirtualIP = "docker.io/darxkies/virtual-ip:1.0.1"
const VersionBusybox = "docker.io/library/busybox:1.36.0"
const VersionPause = "k8s.gcr.io/pause:3.9"
const VersionCoreDNS = "docker.io/coredns/coredns:1.10.0"
const VersionCalicoTypha = "quay.io/calico/typha:v3.25.0"
const VersionCalicoNode = "quay.io/calico/node:v3.25.0"
const VersionCalicoCni = "quay.io/calico/cni:v3.25.0"
const VersionCalicoKubeControllers = "quay.io/calico/kube-controllers:v3.25.0"
const VersionCeph = "quay.io/ceph/ceph:v17.2.5"
const VersionCsiCephPlugin = "quay.io/cephcsi/cephcsi:v3.7.2"
const VersionCsiProvisioner = "k8s.gcr.io/sig-storage/csi-provisioner:v3.2.1"
const VersionCsiAttacher = "k8s.gcr.io/sig-storage/csi-attacher:v3.5.0"
const VersionCsiSnapshotter = "k8s.gcr.io/sig-storage/csi-snapshotter:v6.0.1"
const VersionCsiSnapshotController = "k8s.gcr.io/sig-storage/snapshot-controller:v6.2.1"
const VersionCsiDriverRegistrar = "k8s.gcr.io/sig-storage/csi-node-driver-registrar:v2.5.1"
const VersionCsiResizer = "k8s.gcr.io/sig-storage/csi-resizer:v1.5.0"
const VersionVelero = "docker.io/velero/velero:v1.9.0"
const VersionVeleroPluginAWS = "docker.io/velero/velero-plugin-for-aws:v1.5.0"
const VersionVeleroPluginCSI = "docker.io/velero/velero-plugin-for-csi:v0.3.0"
...
const VersionKubernetesDashboard = "docker.io/kubernetesui/dashboard:v2.6.1"
const VersionCertManagerCtl = "quay.io/jetstack/cert-manager-ctl:v1.9.1"
const VersionCertManagerController = "quay.io/jetstack/cert-manager-controller:v1.9.1"
const VersionCertManagerCAInjector = "quay.io/jetstack/cert-manager-cainjector:v1.9.1"
const VersionCertManagerWebHook = "quay.io/jetstack/cert-manager-webhook:v1.9.1"
const VersionNginxIngressAdmissionWebhook = "k8s.gcr.io/ingress-nginx/kube-webhook-certgen:v1.3.0"
const VersionNginxIngressController = "k8s.gcr.io/ingress-nginx/controller:v1.3.0"
const VersionMetricsServer = "k8s.gcr.io/metrics-server/metrics-server:v0.6.1"
