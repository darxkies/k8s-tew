...
const VersionK8s = "gcr.io/google_containers/hyperkube:v1.18.2"
const VersionEtcd = "quay.io/coreos/etcd:v3.4.7"
const VersionContainerd = "1.3.4"
const VersionRunc = "1.0.0-rc10"
const VersionCrictl = "1.18.0"
const VersionHelm = "3.1.2"
...
const VersionVelero = "docker.io/velero/velero:v1.3.2"
const VersionVeleroPluginAWS = "docker.io/velero/velero-plugin-for-aws:v1.0.1"
const VersionMinioServer = "docker.io/minio/minio:RELEASE.2020-04-15T19-42-18Z"
const VersionMinioClient = "docker.io/minio/mc:RELEASE.2020-04-15T20-18-00Z"
const VersionPause = "gcr.io/google_containers/pause:3.2"
const VersionCoreDNS = "docker.io/coredns/coredns:1.6.9"
...
const VersionCalicoPod2Daemon = "quay.io/calico/pod2daemon-flexvol:v3.13.2"
const VersionCalicoTypha = "quay.io/calico/typha:v3.13.2"
const VersionCalicoNode = "quay.io/calico/node:v3.13.2"
const VersionCalicoCni = "quay.io/calico/cni:v3.13.2"
const VersionCalicoKubeControllers = "quay.io/calico/kube-controllers:v3.13.2"
...
const VersionKubernetesDashboard = "docker.io/kubernetesui/dashboard:v2.0.0-rc7"
...
const VersionCsiProvisioner = "quay.io/k8scsi/csi-provisioner:v1.4.0"
const VersionCsiDriverRegistrar = "quay.io/k8scsi/csi-node-driver-registrar:v1.3.0"
const VersionCsiSnapshotter = "quay.io/k8scsi/csi-snapshotter:v1.2.2"
const VersionCsiResizer = "quay.io/k8scsi/csi-resizer:v0.5.0"
const VersionCsiCephPlugin = "quay.io/cephcsi/cephcsi:v2.1.0"
