...
const VersionEtcd = "quay.io/coreos/etcd:v3.5.9"
...
const VersionCalicoTypha = "quay.io/calico/typha:v3.26.1"
const VersionCalicoNode = "quay.io/calico/node:v3.26.1"
const VersionCalicoCni = "quay.io/calico/cni:v3.26.1"
const VersionCalicoKubeControllers = "quay.io/calico/kube-controllers:v3.26.1"
const VersionCeph = "quay.io/ceph/ceph:v18.2.0"
const VersionCsiCephPlugin = "quay.io/cephcsi/cephcsi:v3.9.0"
const VersionCsiProvisioner = "registry.k8s.io/sig-storage/csi-provisioner:v3.5.0"
const VersionCsiAttacher = "registry.k8s.io/sig-storage/csi-attacher:v4.3.0"
const VersionCsiSnapshotter = "registry.k8s.io/sig-storage/csi-snapshotter:v6.2.2"
const VersionCsiSnapshotController = "registry.k8s.io/sig-storage/snapshot-controller:v6.2.2"
const VersionCsiDriverRegistrar = "registry.k8s.io/sig-storage/csi-node-driver-registrar:v2.8.0"
const VersionCsiResizer = "registry.k8s.io/sig-storage/csi-resizer:v1.8.0"
