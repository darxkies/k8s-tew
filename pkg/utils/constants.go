...
const VersionEtcd = "quay.io/coreos/etcd:v3.6.11"
const VersionContainerd = "2.3.0"
const VersionRunc = "1.4.2"
...
const VersionPause = KubernetesRegistry + "/pause:3.10"
const VersionCoreDNS = "docker.io/coredns/coredns:1.12.0"
const VersionCalicoTypha = "quay.io/calico/typha:v3.29.3"
const VersionCalicoNode = "quay.io/calico/node:v3.29.3"
const VersionCalicoCni = "quay.io/calico/cni:v3.29.3"
const VersionCalicoKubeControllers = "quay.io/calico/kube-controllers:v3.29.3"
const VersionCeph = "quay.io/ceph/ceph:v19.2.2"
const VersionCsiCephPlugin = "quay.io/cephcsi/cephcsi:v3.14.0"
const VersionCsiProvisioner = "registry.k8s.io/sig-storage/csi-provisioner:v5.1.0"
const VersionCsiAttacher = "registry.k8s.io/sig-storage/csi-attacher:v4.8.0"
const VersionCsiSnapshotter = "registry.k8s.io/sig-storage/csi-snapshotter:v8.2.0"
const VersionCsiSnapshotController = "registry.k8s.io/sig-storage/snapshot-controller:v8.2.1"
const VersionCsiDriverRegistrar = "registry.k8s.io/sig-storage/csi-node-driver-registrar:v2.13.0"
const VersionCsiResizer = "registry.k8s.io/sig-storage/csi-resizer:v1.13.1"
