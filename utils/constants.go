...
const VersionCoredns = "docker.io/coredns/coredns:1.6.3"
...
const VersionCalicoTypha = "quay.io/calico/typha:v3.6.1"
const VersionCalicoNode = "quay.io/calico/node:v3.6.1"
const VersionCalicoCni = "quay.io/calico/cni:v3.6.1"
const VersionCalicoKubeControllers = "quay.io/calico/kube-controllers:v3.6.1"
