...
const VersionVelero = "gcr.io/heptio-images/velero:v0.11.0"
...
const VersionCoredns = "docker.io/coredns/coredns:1.4.0"
...
const VersionCalicoTypha = "quay.io/calico/typha:v3.6.0"
const VersionCalicoNode = "quay.io/calico/node:v3.6.0"
const VersionCalicoCni = "quay.io/calico/cni:v3.6.0"
const VersionCalicoKubeControllers = "quay.io/calico/kube-controllers:v3.6.0"
const VersionMetalLBController = "docker.io/metallb/controller:v0.7.3"
const VersionMetalLBSpeaker = "docker.io/metallb/speaker:v0.7.3"
