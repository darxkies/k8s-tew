...
const VersionEtcd = "quay.io/coreos/etcd:v3.3.18"
...
const VersionMetricsScraper = "docker.io/kubernetesui/metrics-scraper:v1.0.2"
const VersionKubernetesDashboard = "docker.io/kubernetesui/dashboard:v2.0.0-beta8"
const VersionCertManagerController = "quay.io/jetstack/cert-manager-controller:v0.12.0"
