...
const VERSION_K8S = "1.12.1"
const VERSION_ETCD = "3.3.9"
const VERSION_CONTAINERD = "1.1.4"
const VERSION_RUNC = "1.0.0-rc5"
const VERSION_CRICTL = "1.12.0"
const VERSION_GOBETWEEN = "0.6.0"
const VERSION_HELM = "2.11.0"
const VERSION_ARK = "gcr.io/heptio-images/ark:v0.9.7"
