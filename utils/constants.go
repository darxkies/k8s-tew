...
const VersionElasticsearchCron = "docker.io/upmcenterprises/elasticsearch-cron:0.1.0"
const VersionElasticsearchOperator = "docker.io/upmcenterprises/elasticsearch-operator:0.3.0"
const VersionKibana = "docker.elastic.co/kibana/kibana-oss:6.1.3"
const VersionCerebro = "docker.io/upmcenterprises/cerebro:0.7.2"
