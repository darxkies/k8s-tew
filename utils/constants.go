...
const VersionCrictl = "1.16.1"
const VersionHelm = "gcr.io/kubernetes-helm/tiller:v2.14.3"
const VersionGobetween = "docker.io/yyyar/gobetween:0.7.0"
const VersionVirtualIP = "docker.io/darxkies/virtual-ip:0.1.4"
const VersionBusybox = "docker.io/library/busybox:1.31.0"
const VersionVelero = "gcr.io/heptio-images/velero:v1.1.0"
const VersionMinioServer = "docker.io/minio/minio:RELEASE.2019-03-20T22-38-47Z"
const VersionMinioClient = "docker.io/minio/mc:RELEASE.2019-03-20T21-29-03Z"
const VersionPause = "k8s.gcr.io/pause:3.1"
const VersionCoredns = "docker.io/coredns/coredns:1.6.4"
const VersionElasticsearch = "docker.elastic.co/elasticsearch/elasticsearch:7.3.2"
const VersionKibana = "docker.elastic.co/kibana/kibana-oss:7.3.2"
const VersionCerebro = "docker.io/lmenezes/cerebro:0.8.3"
const VersionFluentBit = "docker.io/fluent/fluent-bit:1.2.2"
const VersionCalicoTypha = "quay.io/calico/typha:v3.9.1"
const VersionCalicoNode = "quay.io/calico/node:v3.9.1"
const VersionCalicoCni = "quay.io/calico/cni:v3.9.1"
const VersionCalicoKubeControllers = "quay.io/calico/kube-controllers:v3.9.1"
const VersionMetalLBController = "docker.io/metallb/controller:v0.8.1"
const VersionMetalLBSpeaker = "docker.io/metallb/speaker:v0.8.1"
const VersionCeph = "docker.io/ceph/daemon:v4.0.4-stable-4.0-nautilus-centos-7-x86_64"
const VersionMetricsScraper = "docker.io/kubernetesui/metrics-scraper:v1.0.1"
const VersionKubernetesDashboard = "docker.io/kubernetesui/dashboard:v2.0.0-beta4"
...
const VersionNginxIngressController = "quay.io/kubernetes-ingress-controller/nginx-ingress-controller:0.23.0"
const VersionMetricsServer = "k8s.gcr.io/metrics-server-amd64:v0.3.1"
...
const VersionKubeStateMetrics = "k8s.gcr.io/kube-state-metrics:v1.8.0"
const VersionGrafana = "docker.io/grafana/grafana:6.0.1"
const VersionPrometheus = "quay.io/prometheus/prometheus:v2.11.1"
const VersionNodeExporter = "quay.io/prometheus/node-exporter:v0.17.0"
const VersionAlertManager = "quay.io/prometheus/alertmanager:v0.16.0"
const VersionCsiAttacher = "quay.io/k8scsi/csi-attacher:v1.0.1"
const VersionCsiProvisioner = "quay.io/k8scsi/csi-provisioner:v1.0.1"
const VersionCsiDriverRegistrar = "quay.io/k8scsi/csi-node-driver-registrar:v1.0.2"
const VersionCsiCephRbdPlugin = "quay.io/cephcsi/rbdplugin:v1.0.0"
const VersionCsiCephFsPlugin = "quay.io/cephcsi/cephfsplugin:v1.0.0"
const VersionCsiCephSnapshotter = "quay.io/k8scsi/csi-snapshotter:v1.0.1"
...
const HelmBaseName = "helm-{{.Versions.Helm | image_tag}}-linux-amd64"
...
const BinaryContainerdShimRuncV1 = "containerd-shim-runc-v1"
