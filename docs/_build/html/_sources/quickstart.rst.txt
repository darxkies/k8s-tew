...
The following snippet will create a cluster on the host computer or in a virtual machine:
  ...
  .. code:: shell
    ...
    # Download Binary
    wget https://github.com/darxkies/k8s-tew/releases/download/2.3.1/k8s-tew
    chmod a+x k8s-tew
...
.. note:: To use k8s-tew with Vagrant take a look at `https://github.com/darxkies/k8s-tew/tree/2.3.1/setup <https://github.com/darxkies/k8s-tew/tree/2.3.1/setup>`_.
